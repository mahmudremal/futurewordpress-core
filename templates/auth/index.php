...
futurewordpress/project/core/
  ...
  wp_redirect( afuturewordpress/project/core/dpress/project/user/dashboardpermalink', $userInfo->ID, $userInfo->data->user_nicename ) );
  ...
  if( $behaveing == 'redirect' ) {
    ...
    // print_rfuturewordpress/project/core/
