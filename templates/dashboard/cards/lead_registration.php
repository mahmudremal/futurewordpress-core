 ...
 * @package FutureWordPressScrafuturewordpress/project/core/

 */

$userInfo = get_user_by( 'id', hex2bin( get_query_var( 'lead_regfuturewordpress/project/core/
...
if( $regLink && ! empty( $regLink ) && ! $needToSelect ) {
  ...
  if( ! empty( $defaultContract ) ) {
    ...
    wp_die( __( 'Regisatration link not found.', 'futurewordpress-project-core-domain' ) );
...
if( is_wp_error( $userInfo ) || $errorHappens ) :
  ...
  add_filter( 'pre_get_document_title', function( $title ) {
    ...
    $title = apply_filters( 'futurewordpress/project/system/getoption', 'dashboard-title', __( 'Registration Field', 'futurewordpress-project-core-domain' ) );
...
<?php if( true ) : ?>
  ...
  <?php include FUTUREWORDPRESS_PROJECT_CORE_DIR_PATH . '/templates/dashboard/cards/select_registration_page.php'; ?>
            ...
            <div class="container-xxl">
              ...
              <div class="row g-5 g-xxl-12">
                ...
                <div class="col-xl-12">
                  ...
                  <?php // include FUTUREWORDPRESS_PROJECT_CORE_DIR_PATH . '/templates/dashboard/cards/form-wizard.php'; ?>
