...
<form class="form d-flex flex-center" actionfuturewordpress/project/core/min_url( 'admin-post.php' ) ); ?>" method="post">

  <input type="hidden" nafuturewordpress/project/core/ewordpress/project/action/dashboard">

  <input type="hidden" name="userid" value="<?pfuturewordpress/project/core/nfo->ID ); ?>">
futurewordpress/project/core/
  ...
  <div class="card-body mw-800px">
    ...
    <?php if( $alert = (array) get_transient( 'futurewordpress/project/transiant/dashboard/' . get_current_user_id() ) && isset( $alert[ 'type' ] ) && isset( $alert[ 'message' ] ) ) : ?>
      ...
      <div class="alert alert-<?php echo esc_attr( $alert[ 'type' ] ); ?> d-flex align-items-center p-5 mb-10">
        ...
        <div class="d-flex flex-column">
          ...
          <!--begin::Content-->futurewordpress/project/core/

          <span><?php echo wp_kses_post( $afuturewordpress/project/core//span>
    ...
    <div class="row mb-8">futurewordpress/project/core/

      <label class="col-lg-3 col-form-labelfuturewordpress/project/core/il Address', 'futurewordpress-project-core-domain' ); ?></label>
      ...
      <div class="col-lg-9">
        ...
        <?php if( $text = apply_filters( 'futurewordpress/project/core/system/getoption', 'docs-emailaddress', false ) ) : ?>

        <div class="form-text py-2"><?php efuturewordpress/project/core/); ?> 

          <?php if( $url = apply_filters( 'futurewordpress/project/system/getoption', 'docs-emailaddressurl', false ) ) : ?>

          <a href="<?php echo esc_url( $url ); ?>" class="fw-boldk"><?php esc_html_e( 'Learn more', 'futurewordpress-project-core-domain' ); ?></a>.
    ...
    <div class="row mb-8">
      ...
      <label class="col-lg-3 col-form-label"><?php esc_html_e( 'Contact Number', 'futurewordpress-project-core-domain' ); ?></label>
    ...
    <div class="row mb-8">
      ...
      <label class="col-lg-3 col-form-label"><?php esc_html_e( 'Website URL', 'futurewordpress-project-core-domain' ); ?></label>

      <div class="col-lg-9">

        <div class="input-group mb-5 spinnfuturewordpress/project/core/imary spinner-right">

          <input class="form-control form-cfuturewordpress/project/core/olid" type="url" value="<?php echo esc_attr( $userInfo->meta->website ); ?>" name="meta-website" disabled />
        ...
        <?php endif; ?>futurewordpress/project/core/
    ...
    <div class="row mb-8">
      ...
      <label class="col-lg-3 col-form-label"><?php esc_html_e( 'Instagram Handles', 'futurewordpress-project-core-domain' ); ?></label>
    ...
    <div class="row mb-8">
      ...
      <label class="col-lg-3 col-form-label"><?php esc_html_e( 'TikTok Handles', 'futurewordpress-project-core-domain' ); ?></label>
    ...
    <div class="row mb-8">
      ...
      <label class="col-lg-3 col-form-label"><?php esc_html_e( 'YouTube Channel', 'futurewordpress-project-core-domain' ); ?></label>
    ...
    <div class="row mb-8">
      ...
      <label class="col-lg-3 col-form-label"><?php esc_html_e( 'Change Password', 'futurewordpress-project-core-domain' ); ?></label>
      ...
      <div class="col-lg-9">
        ...
        <div class="spinner spinner-sm spinner-primary spinner-right">
          ...
          <button type="button" class="btn btn-light-primary btn-outline fw-bold btn-sm" data-bs-toggle="modal" data-bs-target="#changePasswordform"><?php esc_html_e( 'Click to change Password', 'futurewordpress-project-core-domain' ); ?></button>
            ...
            <div class="modal-body">
              ...
              <form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
                ...
                <div class="form-group my-1">
                    ...
                    <label class="form-label" for="pwd"><?php esc_html_e( 'New Password:', 'futurewordpress-project-core-domain' ); ?></label>
                ...
                <div class="form-group my-1">
                    ...
                    <label class="form-label" for="pwd"><?php esc_html_e( 'Old Password:', 'futurewordpress-project-core-domain' ); ?></label>
                ...
                <div class="form-group my-1">
                    ...
                    <label class="form-label" for="pwd"><?php esc_html_e( 'Confirm Password:', 'futurewordpress-project-core-domain' ); ?></label>
                ...
                <div class="form-group mt-3">
                  ...
                  <button type="submit" class="btn btn-primary"><?php esc_html_e( 'Submit', 'futurewordpress-project-core-domain' ); ?></button>

                  <button type="button" class="btn btn-danger"  data-bs-dismiss="modal"><?php esc_html_e( 'Cancel', 'futurewordpress-project-core-domain' ); ?></button>
    ...
    <!-- <div class="row">
      ...
      <div class="col-lg-9">
        ...
        <button type="submit" class="btn btn-primary fw-bolder px-6 py-3 me-3"><?php esc_html_e( 'Save Changes', 'futurewordpress-project-core-domain' ); ?></button>

        <button type="reset" class="btn btn-color-gray-600 btn-active-light-primary fw-bolder px-6 py-3"><?php esc_html_e( 'Cancel', 'futurewordpress-project-core-domain' ); ?></button>
...
<?php // include FUTUREWORDPRESS_PROJECT_CORE_DIR_PATH . '/templates/dashboard/cards/model.php'; ?>