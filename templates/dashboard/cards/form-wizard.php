  ...
  <div class="card-body">
    ...
    <form id="register-existing-account-wizard" class="mt-3 text-center" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
      ...
      <ul id="top-tab-list" class="p-0 row list-inline">
        ...
        <li class="mb-2 col-lg-3 col-md-6 text-start active" id="account">
          ...
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Account', 'futurewordpress-project-core-domain' ); ?></span>
        ...
        <li id="social" class="mb-2 col-lg-3 col-md-6 text-start">
          ...
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Social', 'futurewordpress-project-core-domain' ); ?></span>
        ...
        <li id="payment" class="mb-2 col-lg-3 col-md-6 text-start">
          ...
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Payment', 'futurewordpress-project-core-domain' ); ?></span>
        ...
        <li id="contract" class="mb-2 col-lg-3 col-md-6 text-start">
          ...
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Contract', 'futurewordpress-project-core-domain' ); ?></span>
      ...
      <fieldset class="active">
        ...
        <div class="form-card text-start mb-2">
          ...
          <div class="row">
            ...
            <div class="col-7">
              ...
              <h3 class="mb-4"><?php esc_html_e( 'Account & Personal Information:', 'futurewordpress-project-core-domain' ); ?></h3>

            </div>

            <!-- <div class="col-5">

              <h2 class="steps mb-4"><?php esc_html_e( 'Step 1 - 4', 'futurewordpress-project-core-domain' ); ?></h2>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="form-label"><?php esc_html_e( 'Email:', 'futurewordpress-project-core-domain' ); ?> *</label>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="form-label"><?php esc_html_e( 'First Name:', 'futurewordpress-project-core-domain' ); ?> *</label>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="form-label"><?php esc_html_e( 'Last Name:', 'futurewordpress-project-core-domain' ); ?> *</label>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="form-label"><?php esc_html_e( 'Display Name:', 'futurewordpress-project-core-domain' ); ?>: *</label>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group my-1">
                ...
                <label class="form-label"><?php esc_html_e( 'Password:', 'futurewordpress-project-core-domain' ); ?> *</label>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group my-1">
                ...
                <label class="form-label"><?php esc_html_e( 'Confirm Password:', 'futurewordpress-project-core-domain' ); ?> *</label>
        ...
        <button type="button" name="next" class="btn btn-primary next action-button float-end" value="Next"><?php esc_html_e( 'Next', 'futurewordpress-project-core-domain' ); ?></button>
      ...
      <fieldset class="">
        ...
        <div class="form-card text-start">
          ...
          <div class="row">
            ...
            <div class="col-7">
              ...
              <h3 class="mb-4"><?php esc_html_e( 'Socials & Connection:', 'futurewordpress-project-core-domain' ); ?></h3>

            </div>

            <div class="col-5">

              <!-- <h2 class="steps mb-4"><?php esc_html_e( 'Step 2 - 4', 'futurewordpress-project-core-domain' ); ?></h2> -->
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <label class="form-label"><?php esc_html_e( 'TikTok Handle:', 'futurewordpress-project-core-domain' ); ?></label>

              <div class="form-group input-group">

                  <span class="input-group-text" id="tiktok-handle">@</span>

                  <input type="text" class="form-control" aria-label="<?php esc_attr_e( 'TikTok Handle:', 'futurewordpress-project-core-domain' ); ?>" aria-describedby="tiktok-handle" name="metadata[tiktok]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->tiktok ); ?>">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="form-label"><?php esc_html_e( 'YouTube Handle:', 'futurewordpress-project-core-domain' ); ?></label>

                <div class="form-group input-group">

                  <span class="input-group-text" id="youtube-handle">@</span>

                  <input type="text" class="form-control" aria-label="<?php esc_attr_e( 'YouTube Handle:', 'futurewordpress-project-core-domain' ); ?>" aria-describedby="youtube-handle" name="metadata[YouTube_url]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->YouTube_url ); ?>">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="form-label"><?php esc_html_e( 'Instagram Handle:', 'futurewordpress-project-core-domain' ); ?></label>

                <div class="form-group input-group">

                  <span class="input-group-text" id="instagram-handle">@</span>

                  <input type="text" class="form-control" aria-label="<?php esc_attr_e( 'YouTube Handle:', 'futurewordpress-project-core-domain' ); ?>" aria-describedby="instagram-handle" name="metadata[instagram_url]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->instagram_url ); ?>">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="form-label"><?php esc_html_e( 'Website Url:', 'futurewordpress-project-core-domain' ); ?></label>
            ...
            <!-- <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="form-label"><?php esc_html_e( 'Contact No.:', 'futurewordpress-project-core-domain' ); ?> *</label>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="form-label"><?php esc_html_e( 'Alternate Contact No.:', 'futurewordpress-project-core-domain' ); ?></label>
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <label class="form-label"><?php esc_html_e( 'Address Line 1:', 'futurewordpress-project-core-domain' ); ?></label>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="form-label"><?php esc_html_e( 'Address Line 2:', 'futurewordpress-project-core-domain' ); ?></label>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="form-label" for="choices-single-default"><?php esc_html_e( 'Country:', 'futurewordpress-project-core-domain' ); ?></label>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="form-label"><?php esc_html_e( 'City:', 'futurewordpress-project-core-domain' ); ?></label>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="form-label"><?php esc_html_e( 'State:', 'futurewordpress-project-core-domain' ); ?></label>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="form-label"><?php esc_html_e( 'Zip Code:', 'futurewordpress-project-core-domain' ); ?></label>
        ...
        <button type="button" name="previous" class="btn btn-dark previous action-button-previous float-end me-1" value="Previous"><?php esc_html_e( 'Previous', 'futurewordpress-project-core-domain' ); ?></button>
      ...
      <fieldset class="">
        ...
        <div class="form-card text-start">
          ...
          <div class="row">
            ...
            <div class="col-7">
              ...
              <h3 class="mb-4"><?php esc_html_e( 'Payment:', 'futurewordpress-project-core-domain' ); ?></h3>

              <!-- <h3 class="mb-4"><?php esc_html_e( 'Image Upload:', 'futurewordpress-project-core-domain' ); ?></h3> -->

            </div>

            <div class="col-5">

              <!-- <h2 class="steps mb-4"><?php esc_html_e( 'Step 3 - 4', 'futurewordpress-project-core-domain' ); ?></h2> -->
          ...
          <div class="row">
                ...
                <div class="card rounded-3">
                  ...
                  <div class="card-body mx-1 my-2">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <p class="d-flex flex-column mb-0">
                          ...
                          <b><?php esc_html_e( 'Pay to proceed on contract.', 'futurewordpress-project-core-domain' ); ?></b>
                      ...
                      <div class="d-flex flex-row pb-3">
                        ...
                        <div class="rounded border border-primary border-2 d-flex w-100 p-3 align-items-center"
                          ...
                          <div class="d-flex flex-column">
                            ...
                            <p class="mb-1 small text-primary"><?php esc_html_e( 'Monthly Retainer', 'futurewordpress-project-core-domain' ); ?></p>
                    ...
                    <div class="d-flex justify-content-between align-items-center pb-1">
                      ...
                      <!-- <a href="<?php echo esc_url( site_url( 'pay_retainer/' . $userInfo->ID . '/' ) ); ?>" class="btn btn-primary btn-lg pay_retainer-amount" target="_blank"><?php esc_html_e( 'Pay amount',   'futurewordpress-project-core-domain' ); ?></a> -->
            ...
            <!-- <div class="col-sm-6">
              ...
              <div class="form-group">
                ...
                <label class="form-label"><?php esc_html_e( 'Upload Your Photo:', 'futurewordpress-project-core-domain' ); ?></label>
        ...
        <!-- <a type="button" href="<?php echo esc_url( site_url( 'pay_retainer/' . $userInfo->ID . '/' ) ); ?>" target="_blank" name="pay-amount" class="btn btn-primary next action-button float-end" value="Submit"><?php esc_html_e( 'Pay Amount', 'futurewordpress-project-core-domain' ); ?></a> -->

        <button type="submit" name="submit" class="btn btn-primary next action-button float-end" value="Submit"><?php esc_html_e( 'Submit', 'futurewordpress-project-core-domain' ); ?></button>
        ...
        <div class="form-card">
          ...
          <div class="row">
            ...
            <div class="col-7">
              ...
              <h3 class="mb-4 text-left"><?php esc_html_e( 'Finish:', 'futurewordpress-project-core-domain' ); ?></h3>

            </div>

            <div class="col-5">

              <!-- <h2 class="steps mb-4"><?php esc_html_e( 'Step 4 - 4', 'futurewordpress-project-core-domain' ); ?></h2> -->
          ...
          <h2 class="text-center text-success">
            ...
            <strong><?php esc_html_e( 'SUCCESS !', 'futurewordpress-project-core-domain' ); ?></strong>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-3">
              ...
              <img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_CORE_BUILD_URI . '/img/img-success.png' ); ?>" class="img-fluid" alt="fit-image" loading="lazy">
          ...
          <div class="row justify-content-center">
            ...
            <div class="text-center col-7">
              ...
              <h5 class="text-center purple-text"><?php esc_html_e( 'You Have Successfully Signed Up', 'futurewordpress-project-core-domain' ); ?></h5>
