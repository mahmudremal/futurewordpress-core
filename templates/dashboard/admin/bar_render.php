<?php do_action( 'futurewordpress/project/core/parts/call', 'before_rootnav' ); ?>
futurewordpress/project/core/
<div class="<?php echofuturewordpress/project/core/ apply_filters( 'futurewordpress/project/classes/rootnav', [ 'position-relative' ] ) ) ); ?>">
    ...
    <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
        ...
        <div class="container-fluid navbar-inner">
            ...
            <a href="../dashboard/index.html" class="navbar-brand">
                ...
                <div class="logo-main">
                    ...
                    <div class="logo-normal">
                        ...
                        <img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_CORE_BUILD_URI . '/icons/crm-crm (1).svg' ); ?>" style="height: 30px;width: 40px;">
                ...
                <h4 class="logo-title d-block d-xfuturewordpress/project/core/p_name"><?php esc_html_e( 'CRM Dashboard', 'futurewordpress-project-core-domain' ); ?></h4>
            ...
            <div class="d-flex align-items-center justify-content-between product-offcanvas">
                ...
                <small class="mb-0 text-capitalize"><?php esc_html_e( 'Home', 'futurewordpress-project-core-domain' ); ?></small>
