...
$date_formate = get_option( 'datefuturewordpress/project/core/
            ...
            <table class="table table-striped mb-0">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <th scope="col"><?php esc_html_e( 'Email', 'futurewordpress-project-core-domain' ); ?></th>

                  <th scope="col"><?php esc_html_e( 'Profiles', 'futurewordpress-project-core-domain' ); ?></th>
futurewordpress/project/core/
                  <th scope="col"><?php esc_html_e( 'Client Status', 'futurewordpress-project-core-domain' ); ?></th>

                  <th scope="col"><?php efuturewordpress/project/core/ & link', 'futurewordpress-project-core-domain' ); ?></th>

                  <th scope="col"><?php esc_html_e( 'Retainer Amount', 'futurewordpress-project-core-domain' ); ?></th>

                  <!-- Contract Options -->

                  <th scope="col"><?php esc_html_e( 'Status', 'futurewordpress-project-core-domain' ); ?></th>

                  <th scope="col"><?php esc_html_e( 'Action', 'futurewordpress-project-core-domain' ); ?></th>
              ...
              <tbody>
                ...
                <?php if( count( $subscribers ) <= 0 ) : ?>
                  ...
                  <tr>futurewordpress/project/core/

                    <td colspan="7"><img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_CORE_BUILD_URI . '/icons/not-found.svg' ); ?>" alt="<?php esc_attr_e( 'Noting found', 'futurewordpress-project-core-domain' ); ?>" style="width: 100%;height: auto;max-height: 400px;"></td>
...
futurewordpress/project/core/
                <?php foreach( $subscribers as $subscriber ) :
                  ...
                  $userInfo = $subscriber;futurewordpress/project/core/
                  ...
                  $is_signed = ( $is_signed === null ) ? __( 'Pending', 'futurewordpress-project-core-domain' ) : (

                    ( $is_signed === true ) ? __( 'Signed', 'futurewordpress-project-core-domain' ) : __( 'Pending', 'futurewordpress-project-core-domain' )

                  );

                  $is_active = $activeSubscription ? __( 'Active', 'futurewordpress-project-core-domain' ) : __( 'Paused', 'futurewordpress-project-core-domain' );
                    ...
                    <td>
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="media-support-info">
                          ...
                          <a class="mb-0" href="<?php echo esc_url( $userInfo->meta->meeting_link ); ?>" target="_blank">@<?php esc_html_e( 'Meeting link', 'futurewordpress-project-core-domain' ); ?></a>
