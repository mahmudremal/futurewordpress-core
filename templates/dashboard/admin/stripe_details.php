  ...
  <div class="row">
    ...
    <div class="card card-full-width rounded m-auto to-print-this-card">
        ...
        <div class="row">
          ...
          <h4 class="mb-3"><?php esc_html_e( 'Invoice', 'futurewordpress-project-core-domain' ); ?>  #<?php echo esc_html( substr( $log->session_id, -20 ) ); ?></h4>
        ...
        <div class="row">
          ...
          <?php echo esc_html( get_option( 'admin_email', '' ) ); ?></p>futurewordpress/project/core/
futurewordpress/project/core/
          </div>

          <div class="col-lg-3">

          <h5><?php esc_html_e( 'Bill from:', 'futurewordpress-project-core-domain' ); ?></h5>

          <p><?php echo esc_html( $userInfo->meta->first_name . ' ' . $userInfo->meta->last_name ); ?></p>

          <p><?php echo esc_html( ! empty( $userInfo->meta->address1 ) ? $userInfo->meta->address1 : (

            ! empty( $userInfo->meta->address2 ) ? $userInfo->meta->address2 : __( 'Address not available', 'futurewordpress-project-core-domain' )
          ...
          <h5><?php esc_html_e( 'Bill fromAmount:', 'futurewordpress-project-core-domain' ); ?></h5>
          ...
          <h5><?php esc_html_e( 'Invoice Date', 'futurewordpress-project-core-domain' ); ?></h5>
          ...
          <div class="table-responsive-lg">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <th scope="col"><?php esc_html_e( 'Description', 'futurewordpress-project-core-domain' ); ?></th>

                  <th scope="col"><?php esc_html_e( 'Price', 'futurewordpress-project-core-domain' ); ?></th>

                  <th scope="col"><?php esc_html_e( 'Quantity', 'futurewordpress-project-core-domain' ); ?></th>

                  <th class="text-end" scope="col"><?php esc_html_e( 'Sub-Total', 'futurewordpress-project-core-domain' ); ?></th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <h5 class="mb-0"><b><?php esc_html_e( 'Net Amount', 'futurewordpress-project-core-domain' ); ?></b></h5>
