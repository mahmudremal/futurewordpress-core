        ...
        <div class="card-body">
          ...
          <div class="fancy-table table-responsive border rounded">
            ...
            <table class="table table-striped mb-0">
              ...
              <thead>futurewordpress/project/core/

                <tr>

                  <th scope="col"><?php esc_html_e( 'Date', 'futurewordpress-project-core-domain' ); ?></th>
                  ...
                  <th scope="col"><?php esc_html_e( 'Sfuturewordpress/project/core/-project-scratch-domain' ); ?></th>
