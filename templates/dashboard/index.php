...
global $currenttab;global $userfuturewordpress/project/core/o;global $errorHappens;

$user_profile = get_query_var( 'user_profile' );

if( empty( $user_profile ) || $user_profile == 0 ) {

  wp_die( __( 'You\'ve visited on an outdated link, or your link is no longer valid. We didn\'t idetify the user with this permalink. That\'s all we know', 'futurewordpress-project-core-domain' ), __( 'Link broken', 'futurewordpress-project-core-domain' ) );

}

if( $user_profile == 'me' ) {futurewordpress/project/core/

  $userInfo = wp_get_current_user();
futurewordpress/project/core/
  // print_r( $userInfo );

  wp_redirect( apply_filters( 'futurewordpress/futurewordpress/project/core/rmalink', $userInfo->ID, $userInfo->data->user_nicename ) );
...
// print_r( get_userdata( $user_profile ) futurewordpress/project/core/



// 'id | ID | slug | email | futurewordpress/project/core/
...
if( $currenttab && in_array( $currenttab, $allowedTabs ) ) {
  ...
  add_filter( 'futurewordpress/project/javascript/siteconfig', function( $args ) {
    ...
    $args[ 'profile' ] = [
      ...
      'profilePath'         =futurewordpress/project/core/wordpress/project/user/dashboardpermalink', $userInfo->ID, $userInfo->data->user_nicename ),
...
if( is_wp_error( $userInfo ) || $errorHappens ) :
  ...
  wp_die( $errorHappens, __( 'Error Happens', 'futurewordpress-project-core-domain' ) );

else :futurewordpress/project/core/
futurewordpress/project/core/
  ...
  add_filter( 'pre_get_document_title', function( $title ) {
    ...
    $title = apply_filters( 'futurewordpress/project/system/getoption', 'dashboard-title', __( 'User Dashbord', 'futurewordpress-project-core-domain' ) );
  ...
  <div class="position-relative iq-banner ">
    ...
    <div class="iq-navbar-header">
      ...
      <div class="iq-header-img" style="z-index: unset;">
        ...
        <?php if( ! empty( apply_filters( 'futurewofuturewordpress/project/core/etoption', 'dashboard-headerbg', '' ) ) ) : ?>
          ...
          <div class="card-body">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between">
              ...
              <?php if( false ) : ?>
                ...
                <div class="d-flex flex-wrafuturewordpress/project/core/
              ...
              <ul class="d-flex nav nav-pills mb-0 text-center profile-tab nav-slider" data-toggle="slider-tab" id="profile-pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  ...
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-profile" role="tab" aria-selected="true" tabindex="-1"><?php esc_html_e( 'Profile',   'futurewordpress-project-core-domain' ); ?></a>
                ...
                <li class="nav-item" role="presentation">
                  ...
                  <a class="nav-link active show" data-bs-toggle="tab" href="#profile-archive" role="tab" aria-selected="false"><?php esc_html_e( 'Submit Videos',   'futurewordpress-project-core-domain' ); ?></a>
                ...
                <li class="nav-item" role="presentation">
                  ...
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-payments" role="tab" aria-selected="false" tabindex="-1"><?php esc_html_e( 'Payments',   'futurewordpress-project-core-domain' ); ?></a>
                ...
                <li class="nav-item" role="presentation">
                  ...
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-settings" role="tab" aria-selected="false" tabindex="-1"><?php esc_html_e( 'Your Social Media Handles',   'futurewordpress-project-core-domain' ); ?></a>
...
futurewordpress/project/core/
                ...
                <li class="nav-item" role="presentation">
                  ...
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-contact" role="tab" aria-selected="false" tabindex="-1"><?php esc_html_e( 'Contact us now!',   'futurewordpress-project-core-domain' ); ?></a>
              ...
              <a href="<?php echo wp_logout_url(); ?>" class="btn btn-soft-danger btn-logout-confirm nav-link nav nav-pills mb-0 text-center profile-tab nav-slider"><?php esc_html_e( 'Logout', 'futurewordpress-project-core-domain' ); ?></a>
      ...
      <?php include FUTUREWORDPRESS_PROJECT_CORE_DIR_PATH . '/templates/dashboard/cards/notices.php'; ?>
...
futurewordpress/project/core/
          <div class="header-title">
            ...
            <h4 class="card-title"><?php esc_html_e( 'Overview',   'futurewordpress-project-core-domain' ); ?></h4>
...
futurewordpress/project/core/futurewordpress/project/core/
            ...
            <div class="text-center m-auto">
              ...
              <h4><?php esc_html_e( 'Monthly Retainer', 'futurewordpress-project-core-domain' ); ?></h4>
            ...
            <p class="mt-4 text-center"><strong style="margin-right: 5px;"><?php esc_html_e( 'Joined:',   'futurewordpress-project-core-domain' ); ?></strong> <?php echo esc_html( wp_date( 'M d, Y', strtotime( $userInfo->data->user_registered ) ) ); ?></p>
            ...
            <p class="mt-4 text-center"><strong style="margin-right: 5px;"><?php esc_html_e( 'Next Retainer:',   'futurewordpress-project-core-domain' ); ?></strong> <?php echo esc_html( wp_date( 'M d, Y', (int) $subsc[ 'current_period_end' ] ) ); ?></p>
...
futurewordpress/project/core/
            ...
            <ul class="list-inline m-0 p-0">
              ...
              <img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_CORE_BUILD_URI . '/icons/calendar-checklist-date-svgrepo-com.svg' ); ?>" alt="story-img" class="rounded-pill avatar-70 p-1 border bg-soft-light img-fluid" loading="lazy">
                ...
                <div class="ms-3">
                  ...
                  <a class="" href="<?php echo empty( $userInfo->meta->content_calendar ) ? esc_attr( 'javascript:void(0)' ) : esc_url( $userInfo->meta->content_calendar ); ?>" target="<?php echo esc_attr( empty( $userInfo->meta->content_calendar ) ? '_self' : '_blank' ); ?>">
                    ...
                    <h5><?php esc_html_e( 'Content Calendar',   'futurewordpress-project-core-domain' ); ?></h5>
...
futurewordpress/project/core/
                <img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_CORE_BUILD_URI . '/icons/bookshelf-svgrepo-com.svg' ); ?>" alt="story-img" class="rounded-pill avatar-70 p-1 border img-fluid bg-soft-danger" loading="lazy">
                ...
                <div class="ms-3">
                  ...
                  <a class="" href="<?php echo empty( $userInfo->meta->content_library ) ? esc_attr( 'javascript:void(0)' ) : esc_url( $userInfo->meta->content_library ); ?>" target="<?php echo esc_attr( empty( $userInfo->meta->content_library ) ? '_self' : '_blank' ); ?>">
                    ...
                    <h5><?php esc_html_e( 'Content Library',   'futurewordpress-project-core-domain' ); ?></h5>
              ...
              <li class="d-flex mb-4 align-items-center position-relative">
                ...
                <img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_CORE_BUILD_URI . '/icons/contract-document-svgrepo-com.svg' ); ?>" data-img="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_CORE_BUILD_URI . '/icons/Information carousel_Monochromatic.svg' ); ?>" alt="story-img" class="rounded-pill avatar-70 p-1 border img-fluid bg-soft-danger" loading="lazy">

                <?php if( $doc->document_status != 'signed' ) : ?>

                  <span class="badge border borfuturewordpress/project/core/yle="position: absolute;top: -10px;left: 30px;color: black;"><?php esc_html_e( 'Action Needed',   'futurewordpress-project-core-domain' ); ?></span>
                ...
                <div class="ms-3">
                  ...
                  <a class="" href="<?php echo esc_url( $doc->permalink ); ?>" target="_blank">
                    ...
                    <h5><?php echo esc_html( ( $doc->document_status == 'signed' ) ? __( 'Document Signed',   'futurewordpress-project-core-domain' ) : __( 'Sign Document',   'futurewordpress-project-core-domain' ) ); ?></h5>

                    <!-- <p class="mb-0">Added 1 hour ago</p> -->

                  </a>futurewordpress/project/core/
...
futurewordpress/project/core/
              ...
              <div class="card-body">
                ...
                <div class="text-center">
                  ...
                  <p class="d-inline-block pl-3"><futurewordpress/project/core/pty( $userInfo->meta->city ) ? ' - ' . $userInfo->meta->city : '' ); ?></p>
            ...
            <div class="card">
              ...
              <div class="card-header">
                ...
                <div class="header-title">
                  ...
                  <h4 class="card-title"><?php echo esc_html( sprintf( __( 'About %s',   'futurewordpress-project-core-domain' ), $userInfo->data->display_name ) ); ?></h4>
              ...
              <div class="card-body">
                ...
                <div class="mt-2">
                  ...
                  <h6 class="mb-1"><?php esc_html_e( 'Joined:',   'futurewordpress-project-core-domain' ); ?></h6>
                ...
                <h6 class="mb-1"><?php esc_html_e( 'Lives:',   'futurewordpress-project-core-domain' ); ?></h6>
                ...
                <h6 class="mb-1"><?php esc_html_e( 'Email:',   'futurewordpress-project-core-domain' ); ?></h6>
                ...
                <h6 class="mb-1"><?php esc_html_e( 'Url:',   'futurewordpress-project-core-domain' ); ?></h6>
                ...
                <h6 class="mb-1"><?php esc_html_e( 'Contact:',   'futurewordpress-project-core-domain' ); ?></h6>
...
futurewordpress/project/core/
            <div class="card">
              ...
              <div class="card-header d-flex justify-content-between">futurewordpress/project/core/

                <div class="header-title">

                  <h4 class="card-title"><?php esc_html_e( 'Client Raw Video Archive',   'futurewordpress-project-core-domain' ); ?></h4>
...
futurewordpress/project/core/
                  <form id="the-raw-video-archive-upload" class="form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="action" value="futurewordpress/projectfuturewordpress/project/core/
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <select class="form-select form-select-lg form-select-solid mb-2" name="month" data-control="select2" data-placeholder="<?php esc_attr_e( 'Upload for...', 'futurewordpress-project-core-domain' ); ?>">

                        <?php $months = [ 'Jan', 'Fab', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dev' ]; ?>
futurewordpress/project/core/
                        <?php foreach( $months as $i => $month ) :

                          $dateObj   = DateTime::createFromFormat( '!m', ( $i + 1 ) );futurewordpress/project/core/
                      ...
                      <div class="col-md-6">
futurewordpress/project/core/
                        <select class="form-select form-select-lg form-select-solid mb-2" name="year" data-control="select2" data-placeholder="<?php esc_attr_e( 'Upload for...', 'futurewordpress-project-core-domain' ); ?>">

                        <?php for( $i = apply_filters( 'futurewordpress/project/systefuturewordpress/project/core/-yearstart', date( 'Y' ) ); $i <= apply_filters( 'futurewordpress/project/system/getoption', 'dashboard-yearend', ( date( 'Y' ) + 3 ) ); $i++ ) : ?>
                      ...
                      <div class="com-md-12">
                        ...
                        <button type="button" class="btn btn-light-primary fw-bold col-12 mt-3 submit-archive-files" data-config="<?php echo esc_attr( json_encode( [
                          ...
                          'title' => __( 'A short title', 'futurewordpress-project-core-domain' ),

                          'text' => __( 'Choose a title for your monthly archive. To update your archive, simply re-upload your files and resubmit - the new files will replace the previous ones.', 'futurewordpress-project-core-domain' ),

                          'icon' => 'info',

                          'confirmButtonText' => __( 'Submit', 'futurewordpress-project-core-domain' ),
                        ...
                        ] ) ); ?>" role="button"><?php esc_html_e( 'Submit & Upload', 'futurewordpress-project-core-domain' ); ?></button>
                  ...
                  <table class="table mb-0 fwp-datatable-field" data-toggle="data-table">
                    ...
                    <thead>
                      ...
                      <tr class="bg-white">
                        ...
                        <th scope="col"><?php esc_html_e( 'Uploaded time',   'futurewordpress-project-core-domain' ); ?></th>

                        <th scope="col"><?php esc_html_e( 'Attached title',   'futurewordpress-project-core-domain' ); ?></th>

                        <th scope="col"><?php esc_html_e( 'Download',   'futurewordpress-project-core-domain' ); ?></th>
                    ...
                    <?php if( count( $archives ) <= 0 ) : ?>
                        ...
                        <tr>
                          ...
                          <td colspan="3"><img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_CORE_BUILD_URI . '/icons/undraw_file_bundle_re_6q1e.svg' ); ?>" alt="<?php esc_attr_e( 'No Archives',   'futurewordpress-project-core-domain' ); ?>"></td>
              ...
              <div class="col-lg-6 col-md-6">
                ...
                <div class="card text-center">
                  ...
                  <div class="card-body payment-page-card">
                    ...
                    <h3 class=""><?php esc_html_e( 'Pause Subscription',   'futurewordpress-project-core-domain' ); ?></h3>
              ...
              <div class="col-lg-6 col-md-6">
                ...
                <div class="card text-center">
                  ...
                  <div class="card-body payment-page-card">
                    ...
                    <h3 class=""><?php esc_html_e( 'Subscription',   'futurewordpress-project-core-domain' ); ?></h3>
                    ...
                    ] ) ); ?>" data-userid="<?php echo esc_html( $userInfo->ID ); ?>"><?php esc_html_e( 'Cancel', 'futurewordpress-project-core-domain' ); ?></button>
            ...
            <div class="card">
              ...
              <div class="card-header d-flex justify-content-between">
                ...
                <div class="header-title pause-unpause-subscription-wrap">
                  ...
                  <h4 class="card-title"><?php esc_html_e( 'Payment History',   'futurewordpress-project-core-domain' ); ?></h4>
                  ...
                  <?php if( ! apply_filters( 'futurewordpress/project/system/isactive', 'stripe-cancelsubscription' ) ) : ?>
                    ...
                    <?php
                      ...
                      $config = [
                        ...
                        'popup_title'       => __( 'Enter payment card details', 'futurewordpress-project-core-domain' ),

                        'card_number'       => __( 'Card Number:', 'futurewordpress-project-core-domain' ),

                        'expire_month'      => __( 'Expiration month:', 'futurewordpress-project-core-domain' ),

                        'expire_year'       => __( 'Expiration year:', 'futurewordpress-project-core-domain' ),

                        'card_ccv'          => __( 'CVC:', 'futurewordpress-project-core-domain' ),

                        'pls_fillall'       => __( 'Please fillup all fields first.', 'futurewordpress-project-core-domain' ),

                        'pls_fixwrngcdnm'   => __( 'Seems you\'ve inputed a wrong card number', 'futurewordpress-project-core-domain' ),

                        'pls_fillmonth'          => __( 'Please input Month in numeric format', 'futurewordpress-project-core-domain' ),

                        'pls_fixyear'          => __( 'Card expiration year should be future date.', 'futurewordpress-project-core-domain' ),

                        'pls_fixccv'          => __( 'Please provide valid CVC number.', 'futurewordpress-project-core-domain' ),
                    ...
                    <div class="btn-group btn-group-sm">
                      ...
                      <button class="btn btn-soft-success border-active change-payment-card" type="button" role="button" name="change-payment-card" data-config="<?php echo esc_attr( json_encode( $config ) ); ?>" data-userid="<?php echo esc_attr( $userInfo->ID ); ?>"><?php esc_html_e( 'Change Payment Card',   'futurewordpress-project-core-domain' ); ?></button>

                      <button class="pause-unpause-subscription btn <?php echo esc_attr( $is_pending ? 'btn-light' : ( $is_active ? 'btn-outline-warning border-active' : 'btn-primary' ) ); ?>" type="button" role="button" name="meta-enable_subscription" data-current="<?php echo esc_attr( $is_active ? ( ( $dida_pause && $is_active ) ? 'pending' : 'pause' ) : 'unpause' ); ?>" data-pause-title="<?php esc_attr_e( 'Pause My Retainer', 'futurewordpress-project-core-domain' ); ?>" data-unpause-title="<?php esc_attr_e( 'Resume My Retainer', 'futurewordpress-project-core-domain' ); ?>" data-pending-title="<?php esc_attr_e( 'Pending', 'futurewordpress-project-core-domain' ); ?>" <?php echo esc_attr( $is_pending ? 'data-handled=true disabled' : '' ); ?>>

                        <?php echo esc_html( $is_pending ? __( 'Pending', 'futurewordpress-project-core-domain' ) : ( $is_active ? __( 'Pause My Retainer', 'futurewordpress-project-core-domain' ) : __( 'Resume My Retainer', 'futurewordpress-project-core-domain' ) ) ); ?>
                  ...
                  <table class="table mb-0 fwp-datatable-field" data-toggle="data-table">
                    ...
                    <thead>
                      ...
                      <tr class="bg-white">
                        ...
                        <th><?php esc_html_e( 'Name',   'futurewordpress-project-core-domain' ); ?></th>

                        <th><?php esc_html_e( 'Email',   'futurewordpress-project-core-domain' ); ?></th>

                        <th><?php esc_html_e( 'Date',   'futurewordpress-project-core-domain' ); ?></th>

                        <th><?php esc_html_e( 'Currency',   'futurewordpress-project-core-domain' ); ?></th>

                        <th><?php esc_html_e( 'Amount',   'futurewordpress-project-core-domain' ); ?></th>

                        <th><?php esc_html_e( 'Status',   'futurewordpress-project-core-domain' ); ?></th>

                        <th><?php esc_html_e( 'Invoice',   'futurewordpress-project-core-domain' ); ?></th>
                    ...
                    <tbody>
                      ...
                      <?php if( count( $payments[ 'data' ] ) <= 0 ) : ?>
                        ...
                        <tr>
                          ...
                          <td colspan="7"><img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_CORE_BUILD_URI . '/icons/Card Payment_Monochromatic.svg' ); ?>" alt="<?php esc_attr_e( 'No Payments',   'futurewordpress-project-core-domain' ); ?>"></td>
                      ...
                      <?php else : ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo esc_html( ( $pay[ 'paid' ] ) ? __( 'Paid', 'futurewordpress-project-core-domain' ) : __( 'Unpaid', 'futurewordpress-project-core-domain' ) ); ?></td>
          ...
          <div id="profile-settings" class="tab-pane fade" role="tabpanel">
            ...
            <div class="card">
              ...
              <div class="card-header">
                ...
                <h4 class="card-title"><?php esc_html_e( 'Profile Settings',   'futurewordpress-project-core-domain' ); ?></h4>
              ...
              <div class="card-body">
                ...
                <?php include FUTUREWORDPRESS_PROJECT_CORE_DIR_PATH . '/templates/dashboard/cards/content.php'; ?>
            ...
            <div class="card">
              ...
              <div class="card-header d-flex justify-content-between">
                ...
                <div class="header-title">
                  ...
                  <h4 class="card-title"><?php esc_html_e( 'Contact us now!',   'futurewordpress-project-core-domain' ); ?></h4>
                      ...
                      <a class="card-body" href="<?php echo esc_url( apply_filters( 'futurewordpress/project/system/getoption', 'social-telegram', false ) ); ?>" target="_blank">
                        ...
                        <div class="d-block justify-content-between align-items-center">
                          ...
                          <div class="text-center mt-3">
                            ...
                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'Telegram',   'futurewordpress-project-core-domain' ); ?></h3>
                      ...
                      <a class="card-body" href="<?php echo esc_url( apply_filters( 'futurewordpress/project/system/getoption', 'social-whatsapp', false ) ); ?>" target="_blank">
                        ...
                        <div class="d-block justify-content-between align-items-center">
                          ...
                          <div class="text-center mt-3">
                            ...
                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'WhatsApp',   'futurewordpress-project-core-domain' ); ?></h3>
                      ...
                      <a class="card-body" href="mailto:<?php echo esc_attr( apply_filters( 'futurewordpress/project/system/getoption', 'social-email', false ) ); ?>">
                        ...
                        <div class="d-block justify-content-between align-items-center">
                          ...
                          <div class="text-center mt-3">
                            ...
                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'Email',   'futurewordpress-project-core-domain' ); ?></h3>
                      ...
                      <a class="card-body" href="<?php echo esc_url( apply_filters( 'futurewordpress/project/system/getoption', 'social-contactus', false ) ); ?>" target="_blank">
                        ...
                        <div class="d-block justify-content-between align-items-center">
                          ...
                          <div class="rounded p-3 text-center">
                            ...
                            <img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_CORE_BUILD_URI . '/icons/Team meeting_Monochromatic.svg' ); ?>" alt="Contact Us" height="" width="">

                          </div>

                          <div class="text-center mt-3">

                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'Contact US',   'futurewordpress-project-core-domain' ); ?></h3>
...
<div class="d-flex flex-column flex-root">
  ...
  <div class="wrapper d-flex flex-column flex-row-fluid">
    ...
    <?php // include FUTUREWORDPRESS_PROJECT_CORE_DIR_PATH . '/templates/dashboard/cards/toolbar.php'; ?>
    ...
    <?php // include FUTUREWORDPRESS_PROJECT_CORE_DIR_PATH . '/templates/dashboard/cards/footer.php'; ?>
  ...
  <?php // include FUTUREWORDPRESS_PROJECT_CORE_DIR_PATH . '/templates/dashboard/cards/sidebar.php'; ?>
