...
(function ($) {
  var FutureWordPress_Frontend = /*#__PURE__*/function () {
    function FutureWordPress_Frontend() {
      var _fwpSiteConfig$ajax_n, _fwpSiteConfig, _fwpSiteConfig$ajaxUr, _fwpSiteConfig2, _fwpSiteConfig$profil, _fwpSiteConfig3, _fwpSiteConfig$i18n, _fwpSiteConfig4;
      _classCallCheck(this, FutureWordPress_Frontend);
      this.ajaxNonce = (_fwpSiteConfig$ajax_n = (_fwpSiteConfig = fwpSiteConfig) === null || _fwpSiteConfig === void 0 ? void 0 : _fwpSiteConfig.ajax_nonce) !== null && _fwpSiteConfig$ajax_n !== void 0 ? _fwpSiteConfig$ajax_n : '';
      ...
      this.lastAjax = false;
      this.profile = (_fwpSiteConfig$profil = (_fwpSiteConfig3 = fwpSiteConfig) === null || _fwpSiteConfig3 === void 0 ? void 0 : _fwpSiteConfig3.profile) !== null && _fwpSiteConfig$profil !== void 0 ? _fwpSiteConfig$profil : false;
      var i18n = (_fwpSiteConfig$i18n = (_fwpSiteConfig4 = fwpSiteConfig) === null || _fwpSiteConfig4 === void 0 ? void 0 : _fwpSiteConfig4.i18n) !== null && _fwpSiteConfig$i18n !== void 0 ? _fwpSiteConfig$i18n : {};
      this.noToast = true;
    ...
    _createClass(FutureWordPress_Frontend, [{
      ...
      key: "setup_tawkto",
      value: function setup_tawkto() {
        var _this$config$tawkalw, _this$config, _this$config$tawkid, _this$config2;
        if ((_this$config$tawkalw = !((_this$config = this.config) !== null && _this$config !== void 0 && _this$config.tawkalw)) !== null && _this$config$tawkalw !== void 0 ? _this$config$tawkalw : false) {
          return;
        }
        var tawk = (_this$config$tawkid = (_this$config2 = this.config) === null || _this$config2 === void 0 ? void 0 : _this$config2.tawkid) !== null && _this$config$tawkid !== void 0 ? _this$config$tawkid : '';
        if (tawk == '') {
          return;
        }
            ...
            myIframes.forEach(function (myIframe, myIframesI) {
              ...
              if (iframeDoc) {
                ...
                if (elementsToRemove && elementsToRemove.length >= 1) {
                  ...
                  var style,
                    css = '.tawk-branding[id], .tawk-dropdown-menu.tawk-dropdown-menu-right > div > .tawk-button:last-child {display: none;}';
        ...
        var twkInterval = setInterval(function () {
          document.querySelectorAll('.tawkto_chattoggle').forEach(function (el, ei) {
            el.addEventListener('click', function (e) {
              e.preventDefault();
              if (typeof Tawk_API === 'undefined' && _typeof(window.Tawk_API) === 'object') {
                var Tawk_API = window.Tawk_API;
              }
              if (typeof Tawk_API === 'undefined') {
                return;
              }
              if (_typeof(Tawk_API) === 'object' && typeof Tawk_API.maximize === 'function') {
