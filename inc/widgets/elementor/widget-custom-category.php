...
use Elementor\Repeater;futurewordpress/project/core/
...
class Widgets_CustomCategory extends \Elementor\Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		wp_register_style( 'listivo-child-widgets', FUTUREWORDPRESS_PROJECT_CORE_BUILD_CSS_URI . '/widgets.css', [], apply_filters( 'futurewordpress/project/filesystem/filemtime', false, FUTUREWORDPRESS_PROJECT_CORE_BUILD_CSS_DIR_PATH . '/widgets.css' ) );
		...
		wp_register_script( 'listivo-child-widgets', FUTUREWORDPRESS_PROJECT_CORE_BUILD_JS_URI . '/widgets.js', [ 'swiper' ], apply_filters( 'futurewordpress/project/filesystem/filemtime', false, FUTUREWORDPRESS_PROJECT_CORE_BUILD_JS_DIR_PATH . '/widgets.js' ), true );



	}

futurewordpress-project-core-domain
...
futurewordpress-project-core-domain
		...
		return __( 'Custom Category Slider', 'futurewordpress-project-core-domain' );
...
futurewordpress-project-core-domain
	 ...
	 * Used to determine where to display thefuturewordpress-project-core-domainor.
...
futurewordpress-project-core-domain
	...
	public function get_categories() futurewordpress-project-core-domain
...
futurewordpress-project-core-domain
	...
	public function get_script_depends() futurewordpress-project-core-domain
...
futurewordpress-project-core-domain
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			'section_content',futurewordpress-project-core-domain
			...
			array(
				...
				'label' => __( 'Content', 'futurewordpress-project-core-domain' ),
		...
		$this->add_control(futurewordpress-project-core-domain



			'show_view_all',futurewordpress-project-core-domain
			...
			[
				...
				'label' => esc_html__('Display "View All" button', 'futurewordpress-project-core-domain'),



				'type' => Controls_Manager::SWITCHER,futurewordpress-project-core-domain



				'return_value' => '1',futurewordpress-project-core-domain
...
futurewordpress-project-core-domain
				...
				'label' => esc_html__('Style', 'futurewordpress-project-core-domain'),
				...
				'options' => [
					...
					'left' => esc_html__('Left', 'futurewordpress-project-core-domain'),



					'right' => esc_html__('Right', 'futurewordpress-project-core-domain'),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __( 'Heading Text', 'futurewordpress-project-core-domain' ),
				...
				'default' => __( 'Heading Text', 'futurewordpress-project-core-domain' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('Show button', 'futurewordpress-project-core-domain'),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('View All Text', 'futurewordpress-project-core-domain'),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __( 'Button Text', 'futurewordpress-project-core-domain' ),
				...
				'default' => __( 'View all', 'futurewordpress-project-core-domain' ),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __( 'View all button link', 'futurewordpress-project-core-domain' ),
		...
		$this->add_control(
				...
				[
						...
						'label' => esc_html__('Image', 'futurewordpress-project-core-domain'),
		...
		$this->start_controls_section(
			...
			array(
				...
				'label' => __( 'Slider', 'futurewordpress-project-core-domain' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__('Category Label', 'futurewordpress-project-core-domain'),
				...
				'placeholder' => __( 'Title Here', 'futurewordpress-project-core-domain' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__('Category URL', 'futurewordpress-project-core-domain'),
				...
				'placeholder' => __( 'Full URL of this category.', 'futurewordpress-project-core-domain' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__('Background Color', 'futurewordpress-project-core-domain'),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('Category Items', 'futurewordpress-project-core-domain'),
